    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental > 1597.00 && frecuenciaFundamental < 1603.00)
                {
                    txt_Color.Text = "Azul";
                }

                if (frecuenciaFundamental > 1197.00 && frecuenciaFundamental < 1203.00)
                {
                    txt_Color.Text = "Morado";
                }

                

                if (frecuenciaFundamental > 397.00 && frecuenciaFundamental < 403.00)
                {
                    txt_Color.Text = "Rojo";
            
                }

                if (frecuenciaFundamental > 797.00 && frecuenciaFundamental < 803.03)
                {
                    txt_Color.Text = "Verde";
                }

                if (frecuenciaFundamental > 1997.00 && frecuenciaFundamental < 2003.00)
                {
                    txt_Color.Text = "Amarillo";
                }
